...
export const getStopInformation = async (routeid: string, direction: string, stopId: string) =>  {

    try {
        let response = await fetch(`https://svc.metrotransit.org/nextripv2/${routeid}/${direction}/${stopId}`);
        let data = await response.json();
